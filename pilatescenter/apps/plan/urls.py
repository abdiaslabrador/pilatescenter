...
urlpatterns = [
	path('list_plan/<int:id_exercise>/', views.ListPlanView.as_view(), name='list_plan'),
    path('create_plan/<int:id_exercise>/', views.CreatePlanView.as_view(), name='create_plan_form'),
